...
$call %SET% PYTHONPATH=..%S%Python%S%api && python ..%S%Python%S%benders_2stage.py ../..
$if errorlevel 1 $abort 'Problem executing benders_2stage.py'

$escape &
$ifThen not %sysenv.p26path% == %&sysenv.p26path%&
$call %SET% PYTHONPATH=..%S%Python%S%api_26 && %sysenv.p26path%%S%python ..%S%Python%S%benders_2stage.py ../..
$if errorlevel 1 $abort 'Problem executing benders_2stage.py with Python 2.6'
$endif