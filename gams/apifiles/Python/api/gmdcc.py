...
def gmdAddSymbol(*args):
  """gmdAddSymbol(pgmd, symName, aDim, type, userInfo, explText) -> void"""
  return _gmdcc.gmdAddSymbol(*args)

def gmdFindSymbol(*args):
  """gmdFindSymbol(pgmd, symName) -> void"""
  return _gmdcc.gmdFindSymbol(*args)

def gmdGetSymbolByIndex(*args):
  """gmdGetSymbolByIndex(pgmd, idx) -> void"""
  return _gmdcc.gmdGetSymbolByIndex(*args)
...
def gmdFindRecord(*args):
  """gmdFindRecord(pgmd, symPtr, aDim, keyStr_in) -> void"""
  return _gmdcc.gmdFindRecord(*args)

def gmdFindFirstRecord(*args):
  """gmdFindFirstRecord(pgmd, symPtr) -> void"""
  return _gmdcc.gmdFindFirstRecord(*args)

def gmdFindFirstRecordSlice(*args):
  """gmdFindFirstRecordSlice(pgmd, symPtr, aDim, keyStr_in) -> void"""
  return _gmdcc.gmdFindFirstRecordSlice(*args)

def gmdFindLastRecord(*args):
  """gmdFindLastRecord(pgmd, symPtr) -> void"""
  return _gmdcc.gmdFindLastRecord(*args)

def gmdFindLastRecordSlice(*args):
  """gmdFindLastRecordSlice(pgmd, symPtr, aDim, keyStr_in) -> void"""
  return _gmdcc.gmdFindLastRecordSlice(*args)
...
def gmdCopySymbolIterator(*args):
  """gmdCopySymbolIterator(pgmd, symIterPtr) -> void"""
  return _gmdcc.gmdCopySymbolIterator(*args)

def gmdFreeSymbolIterator(*args):
  """gmdFreeSymbolIterator(pgmd, symIterPtr)"""
  return _gmdcc.gmdFreeSymbolIterator(*args)

def gmdFreeAllSymbolIterators(*args):
  """gmdFreeAllSymbolIterators(pgmd)"""
  return _gmdcc.gmdFreeAllSymbolIterators(*args)
