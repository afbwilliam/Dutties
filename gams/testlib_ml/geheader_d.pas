...
{ call back messages }
Procedure MsgStat(MsgCallBack: tMsgCallBack; const s: shortstring);
Procedure MsgLog (MsgCallBack: tMsgCallBack; const s: shortstring);
Procedure MsgBoth(MsgCallBack: tMsgCallBack; const s: shortstring);
...
NChar := Length(s);
Mode  := DOSTAT;
MsgCallBack(Mode,NChar,@s[1],NChar);
