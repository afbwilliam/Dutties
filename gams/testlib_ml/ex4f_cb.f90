!     ex4f_cb.f90
!     Fortran implementation of the external functions for example 4
!     (DEA, parameter estimation) in the file ex4.gms.
...
!        Initialization Mode.
         ...
         CALL msg2 (cbType, usrMem, msgcb, 3, '**** Using External Function in ex4f_cb.f90.')
...
!        the very first thing because it holds the size of the model.
	 ...
	 open (putUnit,file='ex4.put',status='old',err=1000)
	 rewind (putUnit)
