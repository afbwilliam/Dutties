*a model from the GAMS model library that illustrates multiple solves
...
$Ontext
  ...
  Reference: Norton R D, and Scandizzo P L, Market Equilibrium Computations
             in Activity Analysis Models, Operations Research, Volume 29,
             Number 2, March 1981.
...
Main topic Solve
Featured item 1 Solves
Featured item 2 Multiple solves
Featured item 3
Featured item 4
Description
