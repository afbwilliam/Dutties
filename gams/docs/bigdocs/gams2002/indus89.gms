...
$stitle set definition
 sets
  z     agroclimatic zones /
                 nwfp    northwest frointier mixed cropping
  ...
  dc(r1)  characteristics of canal command  /
          ...
          flde      field efficiency /
  sa      subareas    /s1*s4/
  wce(dc)       watercourse effeciencies /wce-r, wce-k /
  ...
  wcem(wce,m)   mapping from season to months for watercourse efficiences  /
  ...
  q(cq)   livestock comodities  /cow-milk   milk from cattle cow
                                 buff-milk  milk from buffale cow
                                 meat       from cows buffaloes and bullocks/
  nt      nutrients for animals /tdn  total digestable nutrients
                                 dp   digestable protein   /
  is      irrigation system scenarios /1980*2000  /
  ps      price secenarios / 87-88  /
*--
...
*&&z parameter
*&&z   zone1xxxxx(z,c,t,s,w,m)  bullock requrements (bullock pair hrs per month)
