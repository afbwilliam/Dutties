...
$Ontext
   ...
   Reference: Control Data Corporation, APEX-III Reference Manual
              Version 1.2, PN 76070000, Section 9, " MIP Sample Problem"
              Minneapolis, 1980.
...
Binary variables lease, shift, ssb;
SOS1 variable ss1;
SOS2 variable ss2;
...
Main topic MIP
Featured item 1 SOS1
Featured item 2 SOS2
Featured item 3
Featured item 4
Description
Illustrate sos1 and sos2
