*a model from the GAMS model library used to illustrate sets and subsets
*in a good modeling practice setting
...
$Ontext
   ...
   for irrigation water and to formulate investment ptograms
   in the water sector of egypt.

   Reference: Kutcher G P, The Agro-Economic Model, Technical
              Report 16, Master Plan for Water Resources Development,
              UNDP-EGY-73/024, Cairo, 1980.
...
$Offtext
 ...
 sv(s,c) vegetables by season / winter.(w-veget, w-tomato, w-onion),
   ...
   nt(ag) nuitrients for livestock  /       protein,    starch   /
   cf(c)  fodder crops
